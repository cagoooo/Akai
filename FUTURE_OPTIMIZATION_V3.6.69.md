...
**為什麼**：v3.6.69 已驗證 cockpit beacon 機制可用，但目前只 #1 駕駛艙有。其他高熱度工具（#2 禮堂&專科教室&IPAD平板車預約 +60/週、#3 早安長輩圖、#4 班級小管家 +16/週、#5 手作課程 +20/週）學生直接打 URL 進入仍不計數。**真實流量很可能比現在顯示的還高 2-5 倍**。
...
**為什麼**：目前只有 #1 有「🔥 急上升」徽章。但 #2 禮堂&專科教室&IPAD平板車預約 +60/週、#5 手作課程 +20/週 都明顯「現役火苗」，視覺上完全沒呈現熱度梯度。
...
**收益**：能回答「禮堂&專科教室&IPAD平板車預約系統暴衝 +60/週，是學生在用還是老師在用？是 LINE 連結還是 google 搜尋？」這類過去無解的問題。
