...
阿凱老師教育工具箱是一個整合了 **81 個教育工具** 的一站式平台，專為教師設計，涵蓋以下七大類別：

| 類別 | 圖示 | 說明 | 工具數量 |
|------|------|------|----------|
| 💬 溝通工具 | `communication` | 親師溝通、即時客服等 | 4 |
| 📚 教學工具 | `teaching` | 課堂互動、教案資源、評語優化等 | 12 |
| 🌍 語言學習 | `language` | 打字練習、演說培訓、翻譯工具等 | 7 |
| 📖 閱讀工具 | `reading` | PIRLS 閱讀理解相關工具 | 2 |
| 🔧 實用工具 | `utilities` | 行政系統、抽籤工具、管理平台等 | 16 |
| 🎮 遊戲互動 | `games` | 教育遊戲、互動體驗等 | 15 |
...
| 81 | **國小資訊科技教學駕駛艙入口網** | 整合國小資科教育核心資源，為老師打造的全方位數位教學儀表板 | [開啟工具](https://cagoooo.github.io/it-cockpit/) |
...
| 71 | **成語填空大挑戰** | 專為提升成語能力設計的互動填空遊戲，透過趣味挑戰強化辭彙運用與文學素養 | [開啟工具](https://cagoooo.github.io/typeTC/) |
...
| 80 | **114石小教師會議報告集合站 (下學期)** | 專屬會議與行政資源整合平台，集中管理會議記錄與行政宣導 | [開啟工具](https://sites.google.com/mail2.smes.tyc.edu.tw/114teacher-2/) |
...
| # | 工具名稱 | 說明 | 連結 |
|---|----------|------|------|
| 3 | **學生即時投票系統** | 即時收集學生意見的投票平台，提升課堂互動性與參與度 | [開啟工具](https://cagoooo.github.io/vote/) |
