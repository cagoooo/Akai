...
const tool = {
  ...
  audienceFit: {
    ...
    reasons: {
      teacher:
        '一款打開網址就能玩的 3D 塔防射擊：三種能量武器、三種防禦塔、十波敵人。角色不受傷害、敵人只攻能源核心，失敗回饋落在「這一波的火力沒有守住彎道」這種可以討論、可以修正的策略判斷上，適合當成需要動腦、但不會讓孩子因為手速而挫折的課間活動或獎勵時間。',
      student:
        '切換脈衝步槍、電漿重砲與冰霜射線，在彎道上蓋塔埋伏，撐過十波殭屍守住核心。能源有限，每一次「買塔還是升級」都是真的取捨；手機用雙搖桿也能玩，還能加到主畫面離線挑戰。',
      homeroom:
        '下課、晨光或全班達標後的十分鐘剛好玩完一局。因為玩家角色不受傷害，程度落差大的班級也不會有人一直卡在開頭，願意動腦的孩子則能挑戰第 5、10 波的巨型殭屍。',
      subject:
  ...
  description:
    '三種能量武器、三種防禦塔、十波殭屍。在彎道埋伏、用有限能源在「多蓋一座塔」與「升級舊塔」之間取捨，撐過十波守住能源核心。角色不受傷害、敵人只攻核心，失敗原因落在策略而不是手速，動腦但不挫折；桌機鍵鼠、手機雙搖桿都能玩。',
...
- **角色不受傷害，敵人只攻核心**。這是很關鍵的一個設計取捨：失敗回饋集中在「塔該蓋在哪裡」的策略層面，而不是操作反應，孩子可以放心嘗試不同走位與布陣，挫折感低很多。貨櫃、水塔、油桶與塔本身會擋住玩家射擊，走位仍然有意義。
