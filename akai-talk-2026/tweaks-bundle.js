...
const PALETTES = [
  ["#1B1B6B", "#FAF7F0", "#C73E2A", "#E89B3C"],
  // 學院深藍（預設）
  ["#1F4C3E", "#F4EFE3", "#B9512B", "#C99744"],
  // 墨綠書院
  ["#5B1A24", "#F4EFE3", "#1B1B6B", "#C99744"],
  // 酒紅古典
  ["#1A1A1A", "#F4EFE3", "#C73E2A", "#8A8A8A"]
  // 純黑極簡
];
const SLIDE_BG = {
...
function TweaksApp() {
  ...
  React.useEffect(() => {
    ...
    const titleFamily = t.titleFont === "sans" ? '"Noto Sans TC", "PingFang TC", "Microsoft JhengHei", sans-serif' : '"Noto Serif TC", "Source Han Serif TC", "PingFang TC", serif';
    ...
    sec.forEach((el) => {
      el.style.background = t.sectionStyle === "ink" ? "#0E0E1A" : "";
    });
  }, [t]);
  return /* @__PURE__ */ React.createElement(TweaksPanel, { title: "Tweaks" }, /* @__PURE__ */ React.createElement(TweakSection, { label: "\u8272\u5F69" }), /* @__PURE__ */ React.createElement(
    TweakColor,
    {
      label: "\u914D\u8272\u65B9\u6848",
      value: t.palette,
  ...
  ), /* @__PURE__ */ React.createElement(TweakSection, { label: "\u6392\u7248" }), /* @__PURE__ */ React.createElement(
    TweakRadio,
    {
      label: "\u6A19\u984C\u5B57\u9AD4",
      value: t.titleFont,
  ...
  ), /* @__PURE__ */ React.createElement(TweakSection, { label: "\u5167\u5BB9\u9078\u9805" }), /* @__PURE__ */ React.createElement(
    TweakToggle,
    {
      label: "\u986F\u793A\u82F1\u6587\u526F\u6A19",
      value: t.showEnglish,
...
ReactDOM.createRoot(document.getElementById("tweaks-root")).render(/* @__PURE__ */ React.createElement(TweaksApp, null));
