...
const DEFAULT_TITLE = '科技教育創新專區 · 阿凱老師｜120+ 款國小教育工具';
const DEFAULT_DESCRIPTION = '阿凱老師（桃園市石門國小）親手打造的 120+ 款國小教育科技工具：課堂互動、AI 教案、閱讀評量、語文寫作、教育遊戲一站搞定，100% 免費無廣告，免註冊一鍵分享給學生。';
...
const DEFAULT_IMAGE = `${SITE_URL}/og-preview-66dcd926.png`;
