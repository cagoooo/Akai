...
const CACHE_VERSION = 'v3.6.60-actionsabovefold-202605260830';
...
// ⚠️ 不再 PRECACHE index.html / BASE_PATH — 那會把舊版 HTML 永久 cache 起來，
// 後續 deploy 換新 chunk hash 時舊 HTML 還引用舊 chunk → 404 → 整頁炸開。
// index.html 改走 networkFirst 即可（已在 fetch handler 內），永遠拿最新 HTML。
