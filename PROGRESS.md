...
## 🎯 當前版本狀態
- **當前版本**: `v3.6.89` (本機/CI) · 工具總數 **115 個**（114 + #100 站內索引神器）🎮🚀
- **里程碑**: **2026-07-10 客群推薦精靈納入排行榜人氣 + 熱門保底席** — 主頁「客群 onboarding 推薦精靈」上線後，使用者發現排行榜熱門工具（馬力歐遊戲、班級小管家）沒被推薦。根因是推薦邏輯只吃手工 `priority`，完全沒看真實點擊；改成「人氣加分 + 熱門保底席」雙層機制後，排行榜常勝軍必露出。
- **最後更新狀態**: 見下方 `v3.6.89` 段落
